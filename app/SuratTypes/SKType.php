...
class SKType implements SuratTypeInterface
{
    ...
    {
        return 'filing/surat/create/SK-BRM';
    }

    public function viewPreview(): string
    {
        return 'filing/surat/preview/SK-BRM';
    }

    public function generatePdf(Surat $surat)
    {
        return app(GenerateSKPdf::class)->handle($surat);
    }
}