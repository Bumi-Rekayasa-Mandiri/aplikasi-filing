...
export default function CreateGRS({ surat }: Props) {
  const { data, setData, post, processing, errors } = useForm({
    ...
    isi_surat: '', project: '', material: '', alamat: '', masa_garansi: '',
  ...
  const submit = (e: React.FormEvent) => {
    e.preventDefault()
    if (!surat?.id) return
    post(route('filing.surat.generateGRS-pdf', { surat: surat.id }), {
    ...
    <AuthenticatedLayout>
      ...
      <form onSubmit={submit} className="create-form">
        ...
        <div className="create-form-heading">
          <h1 className="create-form-title">Form data surat pengajuan garansi material</h1>
        ...
        <div className="form-card">
          ...
          <div className="form-grid">
            <div className="field col-span-2">
              ...
              <input className="field-input" placeholder="Contoh: Surat Garansi Material Pagar BRC"
        ...
        <div className="form-card">
          ...
          <div className="form-grid">
            <div className="field col-span-2">
              <label className="field-label">Jenis project</label>
              <textarea className="field-input" placeholder="Deskripsi jenis project"
            ...
            <div className="field">
              ...
              <input className="field-input" placeholder="Jenis material"
                onChange={e => setData('material', e.target.value)} />
            </div>
            <div className="field">
              <label className="field-label">Masa garansi</label>
              <input className="field-input" placeholder="Contoh: 12 bulan"
                onChange={e => setData('masa_garansi', e.target.value)} />
            </div>
            <div className="field col-span-2">
              <label className="field-label">Alamat</label>
              <textarea className="field-input" placeholder="Alamat lengkap"
