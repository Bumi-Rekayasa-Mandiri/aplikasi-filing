// resources/js/components/filing/SuratTable.tsx
import { Surat } from '@/types/filing/surat'
import { router } from '@inertiajs/react'
import SortIcon from '@/components/SortIcon'
import { getPreviewRoute } from '@/types/filing/suratRoutes'
import ArchiveYearModal from '@/components/filing/ArchiveYearModal'
...
export default function SuratTable({
    ...
    return (
        <>
            {/* ── Toolbar: Archive button — muncul di atas tabel ── */}
            <div style={{
                display:        'flex',
                justifyContent: 'flex-end',
                marginBottom:   '10px',
            }}>
                <ArchiveYearModal availableYears={availableYears} />
            </div>
